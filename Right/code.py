...
split = Split(data_pin=board.GP17, data_pin2=board.GP16, use_pio=True, split_side=SplitSide.RIGHT)
...
#                         ]
encoder_handler.map = [ ((KC.MW_UP, KC.MW_DW, False),), # Extra
                        ((KC.MW_UP, KC.MW_DW, False),), # NumPad not yet properly configured
                    ]
# 마지막은 항상 이걸로 끝납니다.
